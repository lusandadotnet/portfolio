    ...
    return (
        <>
            <Image
                ...
                width={70}
                height={70}
                className="w-[70px] h-[70px] rounded-[50%] object-cover object-center ring-2 ring-primary/30"
            ...
            <div className="mt-1.5 flex items-center gap-1 flex-wrap">
                ...
                <p className="text-base text-base-content/60">{about.tagline}</p>
            </div>
            <div className="flex items-center mt-3 gap-3">
                ...
                <a href={socials.twitter} target="_blank">
                    <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-twitter-icon lucide-twitter cursor-pointer hover:text-primary transition-colors"
                    >
